...
const P = {
  ...
  transfer: <><path d="M20.5 7H8a4 4 0 0 0-4 4"/><path d="M17 3.5L20.5 7 17 10.5"/><path d="M3.5 17H16a4 4 0 0 0 4-4"/><path d="M7 13.5L3.5 17 7 20.5"/></>,
  ...
  cart: <><circle cx="9.5" cy="20" r="1.5"/><circle cx="16.5" cy="20" r="1.5"/><path d="M3 3.5h2.2l2.3 11.2a1.8 1.8 0 0 0 1.8 1.4h6.9a1.8 1.8 0 0 0 1.8-1.4L20 7H6"/></>,
